    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="You Are Ban To Use Me. Contact My [Rnp Developer](https://www.telegram.dog/Rnp_Developer).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Somthing Went Wrong. Contact My [Rnp Developer Group](https://www.telegram.dog/Rnp_Developer_Group).",
            parse_mode="markdown",
            disable_web_page_preview=True
        )
        return 400
